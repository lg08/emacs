...

;;;### (autoloads nil "tidy" "tidy.el" (0 0 0 0))
...
If `tidy-config-file' is non-nil parse that file setting variables accordingly." t nil)
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "tidy" '("tidy-")))
