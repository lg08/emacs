...
(let*  (
  ...
  ;; custom -----------------------------------------------------------------------
   ;;;;; company-mode
  `(company-tooltip ((t (:foreground ,blue-1 :background ,background))))
  `(company-tooltip-annotation ((t (:foreground ,purple-1 :background ,background))))
  `(company-tooltip-annotation-selection ((t (:foreground ,purple-1 :background ,background))))
  `(company-tooltip-selection ((t (:foreground ,purple-1 :background ,background))))
  `(company-tooltip-mouse ((t (:background ,background))))
  `(company-tooltip-common ((t (:foreground ,purple-1))))
  `(company-tooltip-common-selection ((t (:foreground ,purple-1))))
  ...
  `(company-preview-common ((t (:foreground ,purple-1 :background ,background))))
